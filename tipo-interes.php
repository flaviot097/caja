    ...
    <div class="container">
        <div class="acciones">
            ...
            <div class="products-container">
                <a class="btn-button-stock-actions" href="crear-tipo-interes-template.php">
                    <button class="btn btn-success" id="crear-sector-top">Crear Tipo</button>
                </a>
                <div id="producto_spam_texto"><b>Tipos de interes mora de cuenta corriente</b></div>
                <div>
                    <?php
                    require_once "componente-tabla-tipos-interes.php";
                    ?>
                </div>
            </div>
        </div>
