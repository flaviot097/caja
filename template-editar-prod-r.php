...
<body>
    ...
    <div class="body-container">
        <div class="container-cartas-fiado">
            <form action="editar-productos-reparto.php" class="card-fiado" method="post">
                <h2 class="text-center">Editar producto</h2><br>
                <h6 class="text-center">**Ingrese campos que desea cambiar**</h6>
                <p class="text-center"><strong>Nombre producto</strong> <br><input type="text" name="nombre">
                </p>
                <input type="hidden" value="<?php $codigo_barra_v = $_POST["codigo_B"] ?? "";
                echo $codigo_barra_v;
                ?>" name="codigo_B">
