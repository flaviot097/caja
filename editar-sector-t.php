    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <div class="products-container">
                <div id="producto_spam_texto">**Introduzca solo los campos a editar**</div>
                <form action="editar-sectores-componente.php" method="post" class="responsive-form">
                    <div class="form-group">
                        <input type="hidden" name="id" value="<?php echo $_POST['id_sector']; ?>">
                        <label for="nombre-sector" id="titles-sectores">Nombre del Sector:</label>
                        <input type="hidden" name="nombresector" value="<?php echo $_POST['nombre_sector']; ?>">
                        <input type="hidden" name="repartodeposito" value="<?php echo $_POST['reparto_deposito']; ?>">
                        <input type="text" id="nombre-sector" name="nombre_sector" placeholder="Ej: Limpieza">
                    </div>
                    <div class="form-group">
