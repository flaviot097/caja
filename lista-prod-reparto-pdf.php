...
$consulataTodosProductos = "SELECT nombre_producto , precio ,codigo_barra FROM producto_reparto order by nombre_producto asc";
...
$dompdf->stream("lista_productos_reparto_pdf", array("Attachment" => true));
