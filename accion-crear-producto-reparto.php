...
$query = "INSERT INTO producto_reparto (nombre_producto, precio, codigo_barra, departamento, proveedor, stock, costo, ganancia, num_stock, fecha) 
...
if ($stmt->execute()) {
    ...
    if ($stmt1->execute()) {
        ...
        header("location: crear-producto-reparto.php");
    }
